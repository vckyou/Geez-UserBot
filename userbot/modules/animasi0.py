...
#Gak Usah Sungkan
#gua Minta Ya Hehe maaf ga bilang dulu 
...
@register(outgoing=True, pattern='^.xta2(?: |$)(.*)') 
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
...
async def typewriter(typew):
    ...
    await typew.edit("👻")
    sleep(2)
    await typew.edit("**⚡xᴛᴀ-ᴘʀᴏᴊᴇᴄᴛ⚡**\n\n [𝚂𝚎𝚗𝚝𝚞𝚑 𝙰𝚔𝚞 𝙱𝚎𝚋](https://github.com/extananjg/Xta-UserBot)\n 𝐓𝐡𝐚𝐧𝐤𝐬 𝐅𝐨𝐫 𝐔𝐬𝐢𝐧𝐠👻")
