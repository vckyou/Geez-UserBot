...
async def amireallyalive(alive):
    ...
    await get_readable_time((time.time() - StartTime))
    output = (
        f"**ㅤㅤㅤㅤ ⚡x ᴛ ᴀ - ᴘ ʀ ᴏ ᴊ ᴇ ᴄ ᴛ⚡**\n"
        f"╔══════════╬════╬══════════╗ \n"
        f"╟⟩⟩ 🤴 • `ᴏᴡɴᴇʀ    :`[xᴛᴀ](t.me/VckyouuBitch)             ㅤ ║\n"
        ...
        f"╚══════════╬════╬══════════╝ \n"
        f" xᴛᴀ - ᴘʀᴏᴊᴇᴄᴛ Menggunakan repo geez-userbot namun sudah di edit sedemikian rupa dan tidak Menghapus credit dari geez \n"
        f"🔰 : [𝗥𝗘𝗣𝗢-𝙂𝙚𝙚𝙯](https://github.com/extananjg/Xta-UserBot)\n👥 : [xᴛᴀ-𝗧𝗘𝗔𝗠](t.me/familykingxtaa)\n👤 : [𝗢𝗪𝗡𝗘𝗥](t.me/xtaaaanj)\n"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def redis(alive):
    ...
    output = (
        ...
        f"╭═───────╼⌘╾───────═ \n"
        f"┃[𝗥𝗲𝗽𝗼](https://github.com/Xta-UserBot)  |  [𝗦𝘂𝗽𝗽𝗼𝗿𝘁](t.me/familykingxtaa)  |  "
        f"[𝗜𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺](https://Instagram.com/eextaa_)\n"
        f"╰═──────╼═⌘═╾───────═")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
